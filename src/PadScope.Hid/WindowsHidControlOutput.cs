...
/// <summary>
/// Windows HID control-transfer output fallback.
///
/// Some DualShock 4 Bluetooth stacks and third-party clones accept output
/// reports through HidD_SetOutputReport but time out when the same report is
/// sent through the interrupt WriteFile path. This helper keeps that Windows
/// transport detail isolated from PadScope's protocol/report builders.
/// </summary>
