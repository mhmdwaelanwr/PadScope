...
public partial class MainWindow
{
    ...
    private void ApplyTopNavigationPolish()
    {
        TabControl? mainTabs = WalkLogicalTree(this)
            ...
            {
                string[] headers = control.Items.OfType<TabItem>()
    ...
    private static Style CreateTopNavigationTabStyle(Brush text, Brush textDim, Brush accent, Brush accentDim)
    {
        ...
        ControlTemplate template = new(typeof(TabItem)) { VisualTree = root };

        Trigger hover = new() { Property = UIElement.IsMouseOverProperty, Value = true };
        ...
        Trigger selected = new() { Property = TabItem.IsSelectedProperty, Value = true };
